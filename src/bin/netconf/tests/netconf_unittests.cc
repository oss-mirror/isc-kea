...
/// @todo: disabled until notifications API is implemented to allow
/// for subscriptions to module installations.
...
TEST_F(NetconfAgentLogTest, logChanges) {
    ...
    EXPECT_NO_THROW(subs->module_change_subscribe(
        KEA_DHCP4_SERVER.c_str(),
        std::bind(&NetconfAgentLogTest::callback, this, ph::_1, ph::_2, ph::_3,
                  ph::_4, ph::_5),
        nullptr, 0, SR_SUBSCR_DONE_ONLY));
