...
///
/// This classes exposes the underlying TLS socket's descriptor for each
...
public:
    ...
    /// the connection's TLS socket.  The passed socket descriptor may be used
    ...
    ///
    /// It is passed the native socket handler of the connection's TLS socket.
    ...
    /// TLS socket. If the read attempt is successful, the client will transmit
